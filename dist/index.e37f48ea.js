...
const KEY = "dfa1fa7e-6dbd-4ad4-ad9a-620281b7d2e8";
...
let fracty = require("70a6f45ae05860c2");
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","url:../../img/icons.svg":"loVOp","./View.js":"5cUXS","fracty":"hJO4d","70a6f45ae05860c2":"hJO4d"}],"loVOp":[function(require,module,exports) {
...
class PaginationView extends (0, _viewJsDefault.default) {
    ...
    <button data-goto="${curPage + 1}" class="btn--inline pagination__btn--next">
        ...
        if (curPage === 1 && numPages > 1) return nextButtonMarkup;
        // Last page
        if (curPage === numPages && numPages > 1) return prevButtonMarkup;
        // Other page
        if (curPage < numPages) return prevButtonMarkup + nextButtonMarkup;
    }
}
