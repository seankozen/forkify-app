...
class RecipeView {
    ...
    #data;
    #errorMessage = "We couldn't find the recipe you were looking for. Please try another one";
    #message = "";
    render(data) {
        this.#data = data;
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","url:../../img/icons.svg":"loVOp","fracty":"hJO4d","70a6f45ae05860c2":"hJO4d"}],"loVOp":[function(require,module,exports) {
